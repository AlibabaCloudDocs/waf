...
具体配置方法，请查看[高防IP结合WAF](../../../../../intl.zh-CN/用户指南/接入WAF/同时部署WAF和DDoS高防.md#)及[CDN结合WAF](../../../../../intl.zh-CN/用户指南/接入WAF/同时部署WAF和CDN.md#) 。
...
Web应用防火墙不支持接入使用NTLM协议认证的网站，经WAF转发的访问请求可能无法通过源站服务器的NTLM认证，导致服务端响应超时。

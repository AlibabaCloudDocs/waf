...
[下载Python示例代码](http://docs-aliyun.cn-hangzhou.oss.aliyun-inc.com/assets/attach/121663/intl_zh/1565691273710/demo.zip)

**说明：** 如果您需要使用以下示例，请替换示例中的公共参数及接口请求参数信息。

## 定义公共参数 {#section_pnm_crm_x2b .section}

``` {#codeblock_7es_3gb_1ny}
#! /usr/bin/env python
# -*- coding: utf-8 -*-
import hashlib
import urllib

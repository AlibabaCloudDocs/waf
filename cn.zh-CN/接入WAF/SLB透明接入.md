...
各版本支持的端口类型和数量说明如下：
    ...
    -   企业版：支持防护由WAF指定的非标准端口，数量限制为10个（包含80、8080、443、8443端口在内；关于端口号的详细说明，请参见[WAF支持的端口](/cn.zh-CN/接入WAF/查看可选端口范围.md)）；不支持防护您业务中的自定义端口。
    -   旗舰版：支持防护50个任意的非标准端口（包含80、8080、443、8443端口和您业务中的自定义端口；关于端口号的详细说明，请参见[WAF支持的端口](/cn.zh-CN/接入WAF/查看可选端口范围.md)）。

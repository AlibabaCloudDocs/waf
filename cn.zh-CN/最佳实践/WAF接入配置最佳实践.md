...
|（针对HTTPS业务）服务端是否使用双向认证|WAF暂时不支持双向认证，需要变更认证方式。|
...
1.  **域名接入配置**
    ...
    -   [单独使用WAF配置指导](../../../../../cn.zh-CN/用户指南/接入WAF/业务接入WAF配置.md#)
    -   [同时部署WAF和DDoS高防配置指导](../../../../../cn.zh-CN/用户指南/接入WAF/同时部署WAF和DDoS高防.md#)
    -   [同时部署WAF和CDN配置指导](../../../../../cn.zh-CN/用户指南/接入WAF/同时部署WAF和CDN.md#)
...
2.  **源站保护配置**
    ...
    -   **标记WAF回源流量**：将网站域名接入WAF进行防护后，您可以为网站域名[设置流量标记](../../../../../cn.zh-CN/用户指南/接入WAF/标记WAF回源流量.md#)。通过设置流量标记的方式，方便地标识经过WAF转发的流量，从而实现精准的源站保护（访问控制）、防护效果分析，有效防止流量绕过WAF请求源站。
3.  **防护策略配置**
    ...
    -   **Web攻击防护**
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/116974/154832505937895_zh-CN.png)
    ...
    -   **CC攻击防护**
        ...
        **说明：** 由于CC防护的攻击紧急模式可能产生一定量的误拦截，如果您的业务为App业务或Web API服务，不建议您开启攻击紧急模式。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/116974/154832505937896_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/116974/154832506038115_zh-CN.png)
